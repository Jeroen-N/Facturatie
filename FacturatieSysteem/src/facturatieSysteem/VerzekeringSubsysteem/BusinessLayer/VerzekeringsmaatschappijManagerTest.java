...
public class VerzekeringsmaatschappijManagerTest {
	...
	public void setUp() throws Exception {
		instance = new Verzekeringsmaatschappij("001", "Naam", "Straat 12", "3333HG", "Plaats", 87654321, 987654321);
	...
	public void testupdateVerzekeringsmaatschappij() throws Exception{
		...
		String plaats = null;
		String expRes = "Breda";
		Verzekeringsmaatschappij maatschappij = new Verzekeringsmaatschappij(nr, "Alex", "Hogeschoollaan 12", "3333GG", "Breda", Integer.parseInt(rekNr), Integer.parseInt(KVK));
		verzekeringDAO.updateMaatschappijXML(maatschappij);
			for (Verzekeringsmaatschappij m1 : verzekeringDAO.getMaatschappijenXML()){
	...
	public void testdeleteVerzekeringstype() throws Exception{
		
	}
	
	public void testaddBehandelcode() throws Exception{
		
	}
	
	public void testdeleteBehandelcode() throws Exception{
	...
	public void testmaatschappijInfo() throws Exception{
		
	}
	
	public void testcheckVerzekering() throws Exception{
		
	}
	
	public void testcheckKVK() throws Exception{
